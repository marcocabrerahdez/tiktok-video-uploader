...
const TermsOfService: React.FC = () => {
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Guess Wizardry.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Guess Wizardry, accessible from{" "}
            <a
              href="https://guesswizardry.vercel.app/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://guesswizardry.vercel.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: guesswizardry@gmail.com</li>
      </ul>
    </div>
  );
};
